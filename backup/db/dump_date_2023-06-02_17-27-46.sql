...
25	37	9934930	WBILMTESTTRACK	453	ab4219087a764ae0btest	Mascaras	30	0	317	2389212	Vivienne Sabo	202
...
SELECT pg_catalog.setval('public.delivery_delivery_id_seq', 63, true);
...
SELECT pg_catalog.setval('public.orders_order_uid_seq', 38, true);
...
SELECT pg_catalog.setval('public.payment_payment_id_seq', 43, true);
